...
namespace Vector3
{
	...
	{
		XMVECTOR v1 = XMVector3Normalize(XMLoadFloat3(&xmf3Vector1));
		XMVECTOR v2 = XMVector3Normalize(XMLoadFloat3(&xmf3Vector2));
		return(Angle(v1, v2));
	}
	...
	{
		XMMATRIX xm2 = XMLoadFloat4x4(&xmmtx4x4Matrix);
		return(TransformNormal(xmf3Vector, xm2));
	}
	...
	{
		XMMATRIX xm2 = XMLoadFloat4x4(&xmmtx4x4Matrix);
		return(TransformCoord(xmf3Vector, xm2));
	}
}
