...
private:
	...
	// 렌더 타켓 버퍼, 서술자 힙 인터페이스 포인터, 렌더 타켓 서술자 원소의 크기이다.
...
public:
	...
	bool OnCreate(HINSTANCE hInstance, HWND hMainWnd); // 프레임워크를 초기화 하는 함수이다(주 윈도우가 생성되면 호출된다).
	void OnDestroy();
